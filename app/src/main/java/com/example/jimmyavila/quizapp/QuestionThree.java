...
public class QuestionThree extends Activity {
    ...
    public void correctAnswer(View view) {
         ...
         */
        TextView additionalInfo = (TextView) findViewById(R.id.additional_info_question_three);
    ...
    /**
     * @param view Goes to next question (question 4)
     */
    public void openNextQuestion(View view) {
        Intent goToQuestionFour = new Intent(this, QuestionFour.class);
        startActivity(goToQuestionFour);
